...
<%
    ...
    else if((int)session.getAttribute("user_right") == 2 || (int)session.getAttribute("user_right") == 3){
        out.println("<script>");
        out.println("alert('매점 관리자 모드로 변경됩니다.')");
        ...
        <div id="pull-right">
            <div class="main-box">
                <%
                    ...
                    ArrayList<FacilityVO> list = dao.ListFacility((String)session.getAttribute("user_school"),1);
